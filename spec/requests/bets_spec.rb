...
RSpec.describe "/bets", type: :request do
  ...
  # BetsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get bets_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Bet" do
        expect {
          post bets_url,
               params: { bet: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Bet" do
        expect {
          post bets_url,
               params: { bet: invalid_attributes }, as: :json
        }.to change(Bet, :count).by(0)
      end

      it "renders a JSON response with errors for the new bet" do
        post bets_url,
             params: { bet: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested bet" do
        bet = Bet.create! valid_attributes
        patch bet_url(bet),
              params: { bet: new_attributes }, headers: valid_headers, as: :json
        bet.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested bet" do
      bet = Bet.create! valid_attributes
      expect {
        delete bet_url(bet), headers: valid_headers, as: :json
      }.to change(Bet, :count).by(-1)
    end
  end
end
